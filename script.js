...
if (cursorDot && cursorRing && window.innerWidth > 991) {
    ...
    const interactiveElements = document.querySelectorAll('a, button, .btn, .project-card, .skills-box, .skills-box-new, .skill-item, .service-box, .cert-card-new, input, textarea');
...
const spotlightCards = document.querySelectorAll('.service-box, .project-card, .skills-box-new');
